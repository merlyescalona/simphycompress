import argparse,datetime,logging,os,sys, simphycompress, msatools
...
def main():
	try:
		...
		prog = simphycompress.SimPhyCompressDataset(cmdArgs)
		prog.run()
	except simphycompress.NRSException as ex:
	    if ex.expression:
	        APPLOGGER.info("simphycompress finished properly.")
